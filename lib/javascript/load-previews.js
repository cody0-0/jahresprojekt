...
function checkParams() {
    ...
    // check date inputs
    const minDateInputs = document.querySelectorAll('[id^="min-time"]');
    const maxDateInputs = document.querySelectorAll('[id^="max-time"]');
    // TODO: implement updating of min/max date filter
}
