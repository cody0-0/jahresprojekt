...
switch (studiengang) {
    case 'minf':
        ...
        favicon.href = new URL('../../resources/imgs/logo_minf_stamp_color.svg', document.currentScript.src).href;
        document.querySelector('html').classList.add('minf');
        break;
    case 'musk':
        headTitle.textContent = 'Medien- und Spielekonzeption';
        favicon.href = new URL('../../resources/imgs/logo_musk_stamp_color.svg', document.currentScript.src).href;
        document.querySelector('html').classList.add('musk');
        break;
    default:
        headTitle.textContent = 'Medien Hochschule Harz';
        favicon.href = new URL('../../resources/imgs/logo_medien_stamp_color.svg', document.currentScript.src).href;
        break;
}